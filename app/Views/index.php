            ...
            <div class="sidebar-inner niceScrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php base_url() ?>" class="waves-effect">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" src="assets/images/users/avatar-2.jpg" alt="user" width="30">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" src="assets/images/users/avatar-3.jpg" alt="user" width="30">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" src="assets/images/users/avatar-4.jpg" alt="user" width="30">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" src="assets/images/users/avatar-5.jpg" alt="user" width="30">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" src="assets/images/users/avatar-6.jpg" alt="user" width="30">
                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0);">Ruby T. Curd</a>
                                                        </td>
